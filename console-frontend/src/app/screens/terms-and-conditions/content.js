const content = `
<h1 id="terms-and-conditions-of-uptous">Terms and Conditions of UPTOUS</h1>
<h2 id="foreword">Foreword</h2>
<p>Our affiliates are very important to us. We do our best to treat you with the fairness and respect you deserve. We simply ask the same consideration of you. We have written the following affiliate agreement with you in mind, as well as to protect our company's good name. So please bear with us as we take you through this legal formality.</p>
<p>If you have any questions, please don't hesitate to let us know. We are strong believers in straight-forward and honest communication. For quickest results please email us at support@uptous.co.</p>
<p>Best regards,</p>
<p>Wolfgang and Daniel <br />Founders of UPTOUS </p>
<h2 id="terms-of-use">Service Agreement</h2>
<p>Please read the entire agreement.<br />
You may print this agreement for your records.<br />
This is a legal agreement between you and Trendiamo Unipessoal Lda. (the legal entity behind UPTOUS) hereinafter referred to as “UPTOUS” (“us”, “we”, “our”).
</p>
<p>By signing up to UPTOUS you are agreeing that you have read and understand the terms and conditions of this agreement and that you agree to be legally responsible for each and every term and condition.</p>
<p>These Terms govern</p>
<ul>
<li>the use of UPTOUS, and,</li>
...
<p>UPTOUS is provided by:</p>
<pre><code>Trendiamo Unipessoal Lda.
Rua de São Bernardo <span class="hljs-number">60</span>A
<span class="hljs-number">1200</span><span class="hljs-number">-826</span> Lisbon, Portugal
</code></pre><p><strong>Owner contact email</strong>: support@uptous.co</p>
<h2 id="what-the-user-should-know-at-a-glance">What the User should know at a glance</h2>
<ul>
<li>Usage of UPTOUS and the Service is age restricted: to access and use UPTOUS and its Service the User must be an adult under applicable law.</li>
</ul>
<h2 id="terms-of-use">TERMS OF USE</h2>
<p>Unless otherwise specified, the terms of use detailed in this section apply generally when using UPTOUS.</p>
...
<p>By using UPTOUS, Users confirm to meet the following requirements:</p>
<ul>
...
<p>Users are responsible for keeping their login credentials confidential and safe. For this reason, Users are also required to choose passwords that meet the highest standards of strength permitted by UPTOUS.</p>
...
<h2 id="conditions-for-account-registration">Conditions for account registration</h2>
<p>Registration of User accounts on UPTOUS is subject to the conditions outlined below. By registering, Users agree to meet such conditions.</p>
<ul>
...
<li>We must not have previously disabled your account for violation of law or any of our terms, conditions and policies.</li>
...
<h2 id="account-suspension-and-deletion">Account suspension and deletion</h2>
...
<h2 id="access-to-accounts-and-affiliate-deals">Access to Accounts and Affiliate Deals</h2>
<p>Access to your account, created revenues and any affiliate deals or their information are only granted to you. Sharing of your account login credentials or the redistribution of affiliate links to third parties in an effort to undermine the process for the third party to create their own account with their own information will result in a termination of this agreement and in a permanent ban from our platform.</p>
<h2 id="affiliate-payments">Affiliate Payments</h2>
<p>UPTOUS uses a third party to handle all of the payments. The third party is Stripe Connect.
By accepting this term agreement you also agree to the account agreement of Stripe Connect which you can find here: <a href="https://stripe.com/en-pt/connect-account/legal">https://stripe.com/en-pt/connect-account/legal</a></p>
<p>Payment will be wired to your bank account on a monthly basis. However, exact dates may vary. We do not take any responsibility for delays in the payment process caused by events such as: bank holidays, technical delays or complications Stripe may encounter, bugs on our end and we reserve the freedom to change the payout date at any given time if need be. It is your responsibility to create and maintain your Stripe Connect account to be able to receive payouts. Failing to set up and connecting your Stripe Connect Account for UPTOUS payouts will prohibit you from receiving any payments. Payments will be withheld until you have created and connected your Stripe Connect Account. If your account is, regardless of the reason, terminated before you have created and connected your Stripe Connect Account any revenues you have generated until then will not be paid out to you. Payments may be withheld in case of fraud detection. The exact amount to be wired to your bank account may vary from the amount stated in the dashboard as our platform operates with multiple currencies that will be converted to the currency of your location. The amount we calculate based on daily updated public exchange rates may be different from the ones our payment provider or your bank applies. When the payout is initiated on the UPTOUS platform your money is being transferred to your Stripe Connect account. From that moment on Stripe it’s Stripes responsibility to make sure the money arrives in the bank account you have connected to your Stripe Connect account.</p>
<h2 id="impact-points-sample-requests">Impact Points & Sample Requests</h2>
<p>You may exchange Impact Points, which you can earn as additional rewards for your successful affiliations, for sample products. In this case we will order the product for you and remove an amount corresponding to the value of the product from your impact point balance. The amount of Impact Points removed from your balance will be a rounded amount of the product costs in Euro. We might in addition remove Impact Points for value of shipping costs if applicable. We are not in any way liable or responsible for the successful delivery of that product to you. We are simply placing an order for you and pay for it. Any liabilities for the delivery and the product itself lie with the brand you ordered it from. By ordering a sample product through UPTOUS you accept that we will communicate your full name, address and email address with the brand you requested the sample from, for them to be able to fulfil your order. Impact Points may not and can not be traded for real money in any way and can not be transferred to other user accounts.</p>
<h2 id="free-sample-requests">Free Sample Requests</h2>
<p>Some brands on the UPTOUS platform may offer sending out free samples to users. The same terms as described in clause 9 apply in this case with the exception of any Impact Point removals. Requesting a free sample product is merely an application we will communicate with the brand. The decision of whether you shall receive a sample or not is completely up to the brand. We do not take any guarantees for the acceptance of your application. We are not liable for any additional terms or other agreements you may communicate with the brand.</p>
<h2 id="content-on-uptous">Content on UPTOUS</h2>
<p>Unless where otherwise specified or clearly recognizable, all content available on UPTOUS is owned or provided by the Owner or its licensors.</p>
<p>The Owner undertakes its utmost effort to ensure that the content provided on UPTOUS infringes no applicable legal provisions or third-party rights. However, it may not always be possible to achieve such a result.</p>
...
<h2 id="rights-regarding-content-on-uptous-all-rights-reserved">Rights regarding content on UPTOUS - All rights reserved</h2>
...
<h2 id="content-provided-by-users">Content provided by Users</h2>
<p>The Owner allows Users to upload, share or provide their own content to UPTOUS.</p>
<p>By providing content to UPTOUS, Users confirm that they are legally allowed to do so and that they are not infringing any statutory provisions and/or third-party rights.</p>
<p>Users acknowledge and accept that by providing their own content to UPTOUS they grant the Owner a non-exclusive, worldwide, fully paid-up and royalty-free, irrevocable, perpetual (or for the entire protection term), sub-licensable and transferable license to use, access, store, reproduce, modify, distribute, publish, process into derivative works, broadcast, stream, transmit or otherwise exploit such content to provide and promote its Service in any media or manner.
To the extent permitted by applicable law, Users waive any moral rights in connection with content they provide to UPTOUS.</p>
<p>Users acknowledge, accept and confirm that all content they provide through UPTOUS is provided subject to the same general conditions set forth for content on UPTOUS. Users are solely liable for any content they upload, post, share, or provide through UPTOUS. Users acknowledge and accept that the Owner filters or moderates such content in a preventative manner.</p>
...
Users agree to hold the Owner harmless from and against any claim asserted and/or damage suffered due to content they provided to or provided through UPTOUS.</p>
<h2 id="access-to-external-resources">Access to external resources</h2>
<p>Through UPTOUS Users may have access to external resources provided by third parties. Users acknowledge and accept that the Owner has no control over such resources and is therefore not responsible for their content and availability.</p>
...
<p>UPTOUS and the Service may only be used within the scope of what they are provided for, under these Terms and applicable law.</p>
<p>Users are solely responsible for making sure that their use of UPTOUS and/or the Service violates no applicable law, regulations or third-party rights.</p>
<p>Therefore, the Owner reserves the right to take any appropriate measure to protect its legitimate interests including by denying Users access to UPTOUS or the Service, terminating contracts, reporting any misconduct performed through UPTOUS or the Service to the competent authorities – such as judicial or administrative authorities - whenever Users engage or are suspected to engage in any of the following activities:</p>
<ul>
...
Unless damages have been caused by way of intent or gross negligence, or they affect life, health or physical integrity, the Owner shall only be liable to the extent of typical and foreseeable damages at the moment the contract was entered into.</p>
...
The Service may become inaccessible or it may not function properly with Users’ web browser, mobile device, and/or operating system. The owner cannot be held liable for any perceived or actual damages arising from Service content, operation, or use of this Service.</p>
...
<li>any damage, loss or injury resulting from hacking, tampering or other unauthorized access or use of the Service or User account or the information contained therein;</li>
...
<li>any unauthorized access to or use of the Owner’s secure servers and/or any and all personal information stored therein;</li>
...
<p>Users may not reproduce, duplicate, copy, sell, resell or exploit any portion of UPTOUS and of its Service without the Owner’s express prior written permission, granted either directly or through a legitimate reselling program.</p>
<h3 id="privacy-policy">Privacy policy</h3>
<p>To learn more about the use of their Personal Data, Users may refer to the privacy policy of UPTOUS.</p>
<h3 id="intellectual-property-rights">Intellectual property rights</h3>
<p>Without prejudice to any more specific provision of these Terms, any intellectual property rights, such as copyrights, trademark rights, patent rights and design rights related to UPTOUS are the exclusive property of the Owner or its licensors and are subject to the protection granted by applicable laws or international treaties relating to intellectual property.</p>
<p>All trademarks — nominal or figurative — and all other marks, trade names, service marks, word marks, illustrations, images, or logos appearing in connection with UPTOUS are, and remain, the exclusive property of the Owner or its licensors and are subject to the protection granted by applicable laws or international treaties related to intellectual property.</p>
...
<p>All communications relating to the use of UPTOUS must be sent using the contact information stated in this document.</p>
...
<p>Latest update: September 24, 2019</p>
<p><strong>UPTOUS (or this Application)</strong></p>
...
<p><strong>European (or Europe)</strong></p>
...
<p>Indicates the natural person(s) or legal entity that provides UPTOUS and/or the Service to Users.</p>
<p><strong>Service</strong></p>
<p>The service provided by UPTOUS as described in these Terms and on UPTOUS.</p>
<p><strong>Terms</strong></p>
<p>All provisions applicable to the use of UPTOUS and/or the Service as described in this document, including any other related documents or agreements, and as updated from time to time.</p>
<p><strong>User (or You)</strong></p>
<p>Indicates any natural person or legal entity using UPTOUS.</p>
`
