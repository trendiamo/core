...
//     	return "hsla(" + Math.round(h) + ", 70%, 70%, " + a + ")";
//     }
//
...
//           const randomLine = { color: generateRandomHSL(), x: Math.random() * 100 + 100, y: Math.random() * 100 + 100, speed: Math.random() * 10, direction: Math.random() * Math.PI * 2, life: 0, lifeSpan: Math.floor(Math.random() * 30 + 30), width: Math.round(Math.random() * 10), height: Math.round(Math.random() * 10) };
//           console.log(randomLine);
//           randomLines.push(randomLine);
//         }
//
//         randomLines = randomLines.filter(function(line){
//           	line.life++;
//           	line.x += Math.cos(line.direction) + line.speed;
//           	line.y += Math.sin(line.direction) + line.speed;
//             ctx.fillStyle = line.color;
//         	ctx.fillRect(line.x - line.width / 2, line.y - line.height / 2, line.width / 2, line.height / 2);
//             return line.life < line.lifeSpan;
//         });
//     }
//
//
