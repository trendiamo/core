...
exports.SET_FILTER = exports.SET_PER_PAGE = exports.SET_PAGE = exports.SORT_DESC = exports.SORT_ASC = exports.SET_SORT = undefined;
...
exports.default = function (previousState, _ref) {
    ...
    switch (type) {
        ...
        case SET_PER_PAGE:
            return (0, _extends3.default)({}, previousState, { perPage: payload });
