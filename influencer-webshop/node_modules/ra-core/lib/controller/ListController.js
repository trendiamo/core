...
var ListController = exports.ListController = function (_Component) {
    ...
    (0, _createClass3.default)(ListController, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            if (nextProps.resource !== this.props.resource || nextProps.query.sort !== this.props.query.sort || nextProps.query.order !== this.props.query.order || nextProps.query.page !== this.props.query.page || nextProps.query.perPage !== this.props.query.perPage || !(0, _isEqual2.default)(nextProps.query.filter, this.props.query.filter) || !(0, _isEqual2.default)(nextProps.filter, this.props.filter) || !(0, _isEqual2.default)(nextProps.sort, this.props.sort) || !(0, _isEqual2.default)(nextProps.perPage, this.props.perPage)) {
