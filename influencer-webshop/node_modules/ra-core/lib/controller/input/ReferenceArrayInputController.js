    ...
    (0, _createClass3.default)(ReferenceArrayInputController, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            if ((this.props.record || {}).id !== (nextProps.record || {}).id) {
                ...
                if (!(0, _isEqual2.default)(nextProps.filter, this.props.filter)) {
                    this.params = (0, _extends3.default)({}, this.params, { filter: nextProps.filter });
                    shouldFetchOptions = true;
                }
                if (!(0, _isEqual2.default)(nextProps.sort, this.props.sort)) {
                    this.params = (0, _extends3.default)({}, this.params, { sort: nextProps.sort });
                    shouldFetchOptions = true;
                }
                if (nextProps.perPage !== this.props.perPage) {
                    this.params = (0, _extends3.default)({}, this.params, {
                        pagination: (0, _extends3.default)({}, this.params.pagination, {
