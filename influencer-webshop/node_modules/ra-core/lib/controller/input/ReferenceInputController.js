            ...
            if ((this.props.record || {}).id !== (nextProps.record || {}).id) {
                ...
                this.setState(function (state) {
                    return {
                        ...
                        pagination: (0, _extends3.default)({}, state.pagination, {
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.fetchOptions = function () {
        ...
        crudGetMatchingAccumulate(reference, referenceSource(resource, source), pagination, sort, (0, _extends3.default)({}, filterFromProps, filter));
    };
};
...
ReferenceInputController.propTypes = {
    ...
    crudGetMatchingAccumulate: _propTypes2.default.func.isRequired,
...
var EnhancedReferenceInputController = (0, _compose2.default)(_translate2.default, (0, _reactRedux.connect)(makeMapStateToProps(), {
    ...
    crudGetMatchingAccumulate: _accumulateActions.crudGetMatchingAccumulate
