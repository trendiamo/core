...
dokku config:set slack-bot SLACK_API_TOKEN=... BUILD_FOLDER=/tmp GITHUB_KEY_FILE=/app/files/deploy_id_rsa DOKKU_KEY_FILE=/app/files/dokku_id_rsa STATIC_KEY_FILE=/app/files/static_id_rsa LANDING_PAGE_ENV_FILE=/app/files/landing-page/.env
