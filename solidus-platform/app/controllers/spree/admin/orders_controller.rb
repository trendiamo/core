...
module Spree
  module Admin
    class OrdersController < Spree::Admin::BaseController
      ...
      before_action :load_order, only: [:edit, :update, :complete, :advance, :cancel, :resume, :approve, :resend, :issue_invoice, :unfinalize_adjustments, :finalize_adjustments, :cart, :confirm]
      around_action :lock_order, only: [:update, :advance, :complete, :confirm, :cancel, :resume, :approve, :resend, :issue_invoice]
      ...
      def issue_invoice
        CreateInvoice.new(@order).perform
      end
