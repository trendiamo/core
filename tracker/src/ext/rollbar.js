...
export const Rollbar = {
  error(...args) {
    return document.querySelector('.frekkls-tracker-loading-frame').contentWindow.Rollbar.error(...args)
  },
  warning(...args) {
    return document.querySelector('.frekkls-tracker-loading-frame').contentWindow.Rollbar.warning(...args)
  },
  critical(...args) {
    return document.querySelector('.frekkls-tracker-loading-frame').contentWindow.Rollbar.critical(...args)
  },
}
